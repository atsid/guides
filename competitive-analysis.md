...
Who is our competitor? We start by identifying similar industries and researching the product or methods they currently use. There needs to be a metric established by the team on what business or heuristic features of the competitors product you are evaluating. 
...
# References 
* [UI Heuristic List by Jakob Neilson]( https://www.nngroup.com/articles/ten-usability-heuristics )
* [UX Strategy by Jamie Levy](https://books.google.com/books/about/UX_Strategy.html?id=3SB0CQAAQBAJ&printsec=frontcover&source=kp_read_button#v=onepage&q&f=false )
