...
> "First seek to understand and then to be understood. -A"
...
By inviting multiple people from different backgrounds the team gains different, business, product, and engineering perspectives that help quickly identify the user's needs and their possible constraints. A way to guide the workshop is by writing up a short brief about your design project so that the team may help you find these areas:
...
A great way to time box the sketching is using the “Crazy 8s” method.
...
Check out this quick video for tips on how to facilitate this exercise. [Udacity Crazy 8s](https://youtu.be/27lVhXF5s9c)
...
Time boxed 6 sessions that run "5-10 min max" or you can do multiple rounds of “Crazy 8’s”
...
* [WillowTree App - great ideas on how to run your sessions. ](http://willowtreeapps.com/blog/3-steps-to-running-design-studio-workshops-best-practices-tips/)
