...
A great way to time box the sketching is using the [Crazy Eights]({{site.baseurl}}/crazy-eights) method.
...
Check out this [Udacity Crazy 8s video](https://youtu.be/27lVhXF5s9c) for tips on how to facilitate this exercise.
